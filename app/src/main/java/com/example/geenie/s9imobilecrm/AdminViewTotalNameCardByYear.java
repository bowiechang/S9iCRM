...
public class AdminViewTotalNameCardByYear extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_total_name_card_by_year);
        //status bar
    ...
    public void retrieveData(String yearkey){
        ...
        for (int i = 0; i < companyList.size(); i++) {
            ...
            //get the month out
            String [] dateSplit = companyList.get(i).getDateCreated().split("/");
            System.out.println("apptmade:: year from split: " + dateSplit[2]);
            if(dateSplit[2].equalsIgnoreCase(yearkey)){
                counterlist.add(companyList.get(i).getCreateBy());
        ...
        System.out.println("apptmade:: apptlist: " + companyList.size());
        ...
        pie.setOnClickListener(new ListenersInterface.OnClickListener(new String[]{"x", "value"}) {
            ...
            public void onClick(Event event) {
                Toast.makeText(AdminViewTotalNameCardByYear.this, event.getData().get("x") + " Made " + event.getData().get("value") + " Appointment", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onSupportNavigateUp() {
        Intent i = new Intent(AdminViewTotalNameCardByYear.this, AdminTotalNameCardMonthOrYear.class);
        AdminViewTotalNameCardByYear.this.startActivity(i);
        return true;
    }
    ...
    public void onClick(View view) {
        if(view.equals(tvGo)){
            Intent intent = new Intent(this, AdminViewTotalNameCardByYear.class);
