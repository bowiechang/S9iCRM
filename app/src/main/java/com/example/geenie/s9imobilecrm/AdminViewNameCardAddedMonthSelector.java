...
public class AdminViewNameCardAddedMonthSelector extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_name_card_added_month);
    ...
    public void onClick(View view) {
        if(view.equals(rlJan)){
            Intent intent = new Intent(this, AdminViewNameCardDetailedMonth.class);
    ...
    public boolean onSupportNavigateUp() {
        Intent i = new Intent(AdminViewNameCardAddedMonthSelector.this, AdminMainActivity.class);
        AdminViewNameCardAddedMonthSelector.this.startActivity(i);
        return true;
    }
}
